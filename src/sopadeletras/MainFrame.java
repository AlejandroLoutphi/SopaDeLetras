...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Title, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 0, 270, 60));
    ...
    private void visualizeGraph(AdjacencyMatrixGraph<Character> graph) {
        ...
        for (int i = 0; i < graph.size(); i++) {
            ...
            vis.getNode(vertexOrEdgeId).setAttribute("ui.style", "text-alignment: under;");
        ...
        for (int i = 0; i < graph.size(); i++) {
            for (int j = 0; j < graph.size(); j++) {
                if (graph.hasEdge(i, j)) {
                    ...
                    //vis.getEdge(vertexOrEdgeId).setAttribute("ui.label", vertexOrEdgeId + " (" + arista.getdistancia() + ")");
                }
            }
        }
        
        System.setProperty("org.graphstream.ui", "swing");
        Viewer viewer = vis.display(true);
    ...
    private void FindWordButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_FindWordButtonActionPerformed
        ...
        switch (selectedAlgorithm) {
            case "BFS":
                wordFound = foundStringBfsWithVis(uppercaseWord);
                break;
            case "DFS":
